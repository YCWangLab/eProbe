...
Bundled with eProbe for convenience.
Original source: https://github.com/isaacovercast/easySFS
'''
import argparse, copy, gzip, os, shutil, sys
import numpy as np
import pandas as pd

# Handle import whether run as script or as module
try:
    from eprobe.external.Spectrum import Spectrum
except ImportError:
